...
// The hand-off pages are the point of tagging work in the first place - one
// page saying what one builder puts down in one stage - so they ship by
// default. Untick the ones you do not need.
const GROUP_ON={whole:true, stagesAll:true, stage:true, buildersAll:true, builder:true, pair:true, key:false};
