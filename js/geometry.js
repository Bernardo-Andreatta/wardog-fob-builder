...
export function hitPiece(wx,wy){
  ...
  for(const {p} of order){
    ...
    // The view is the reach: work ghosted out because it belongs to another
    // stage or another hand is there for context, not to be picked up by
    // accident while you work on what is lit.
    if(!planLit(p)) continue;
